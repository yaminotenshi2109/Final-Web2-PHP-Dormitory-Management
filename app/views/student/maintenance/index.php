...
<?php else: ?>
  <div class="card">
    <div class="empty-state"><div class="empty-icon">🔧</div><div class="empty-title">Chưa có yêu cầu</div><div class="empty-msg">Gửi yêu cầu bảo trì khi phòng cần sửa chữa.</div></div>
  </div>
<?php endif; ?>
