...
function fieldError(array $errors, string $field): string {
    if (isset($errors[$field])) {
        return '<div class="form-error"> ' . htmlspecialchars($errors[$field]) . '</div>';
    }
    return '';
}
...
<div style="max-width:600px;margin:0 auto;">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?= getDynamicUrl('/student/registrations') ?>" method="POST" id="registrationForm">
                <input type="hidden" name="_csrf_token" value="<?= htmlspecialchars($csrfToken) ?>">
                <input type="hidden" name="_method" value="POST">

                <!-- Preferred Building -->
                <div class="form-group">
                    <label class="form-label" for="preferred_building_id">Tòa nhà ưu tiên
                ...
                <!-- Preferred Room Type -->
                <div class="form-group">
                    <label class="form-label" for="preferred_room_type">Loại phòng ưu tiên
                        <span style="font-weight:400;color:#94a3b8;font-size:12px;">(Tuỳ chọn)</span>
                    </label>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px;">
                    <div style="background:#f8fafc;border-radius:10px;padding:12px;border:1px solid #e2e8f0;">
                        <div style="font-weight:700;font-size:13px;color:#1e293b;margin-bottom:4px;"> Phòng thường</div>
                    ...
                    <div style="background:#eff6ff;border-radius:10px;padding:12px;border:1px solid #bfdbfe;">
                        <div style="font-weight:700;font-size:13px;color:#1e40af;margin-bottom:4px;"> AC Standard</div>
                        <div style="font-size:12px;color:#3b82f6;">Phòng thường có trang bị điều hoà nhiệt độ.</div>
                    </div>
                    <div style="background:#eff6ff;border-radius:10px;padding:12px;border:1px solid #bfdbfe;">
                        <div style="font-weight:700;font-size:13px;color:#1e40af;margin-bottom:4px;">⭐ AC Deluxe</div>
                ...
                <!-- Notes -->
                <div class="form-group">
                    <label class="form-label" for="notes">Ghi chú / Yêu cầu đặc biệt
                        <span style="font-weight:400;color:#94a3b8;font-size:12px;">(Tuỳ chọn)</span>
                    </label>
                ...
                <div style="display:flex;gap:12px;flex-wrap:wrap;">
                    ...
                    <a href="<?= getDynamicUrl('/student/registrations') ?>" class="btn btn-outline" style="flex:1;min-width:120px;text-align:center;">
                         Huỷ bỏ
                    </a>
                </div>
            </form>
