...
<div class="page-header">
  <div><h1 class="page-title"> Ghi nhận vi phạm</h1><p class="page-subtitle">Tạo bản ghi vi phạm nội quy mới</p></div>
  ...
  <div class="card-body">
    <form method="POST" action="<?= getDynamicUrl('/admin/violations') ?>">
      ...
      <div style="display:flex;gap:10px;justify-content:flex-end;margin-top:24px;padding-top:20px;border-top:1px solid var(--border)">
        ...
        <button type="submit" class="btn btn-danger"> Ghi nhận vi phạm</button>
      </div>
    </form>
  </div>
</div>
